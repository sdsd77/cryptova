...
(function (window) {
    ...
    var DICT = {
        ...
        'svcp.step1.tech': { ar: 'تواصل معنا وشاركنا احتياجك أو فكرتك.', en: 'Reach out and share your need or idea with us.' },
        ...
        'svcp.step2.techdesc': { ar: 'نحدد المتطلبات ونبني تصورًا واضحًا للمشروع.', en: 'We define the requirements and build a clear vision for the project.' },
        ...
        'svcp.step3.techdesc': { ar: 'نحوّل التصميم إلى موقع أو تطبيق أو نظام يعمل فعليًا.', en: 'We turn the design into a working website, app, or system.' },
        ...
        'svcp.step4.techdesc': { ar: 'نختبر المشروع، نجهزه للإطلاق، ونوفر الدعم بعد التسليم.', en: 'We test the project, prepare it for launch, and provide post-delivery support.' },
        ...
        // ─── Tech services page: how we work (impact journey) ───
        'svcp.tech.proc1.t': { ar: 'أخبرنا بفكرتك', en: 'Tell Us Your Idea' },
        'svcp.tech.proc2.t': { ar: 'نخطط ونصمم', en: 'We Plan & Design' },
        'svcp.tech.proc3.t': { ar: 'نطوّر وننفّذ', en: 'We Develop & Build' },
        'svcp.tech.proc4.t': { ar: 'نطلق وندعم', en: 'We Launch & Support' },
        ...
        'page.tech.title': { ar: 'من فكرة إلى واقع', en: 'From Idea to Reality' },
        'page.tech.subtitle': { ar: 'نصمم ونطوّر المواقع والتطبيقات والأنظمة الرقمية، من الفكرة الأولى حتى الإطلاق.', en: 'We design and build websites, apps, and digital systems — from the first idea to launch.' },
        'svcp.build.badge': { ar: 'من خيالك', en: 'From Your Imagination' },
        'svcp.build.title': { ar: 'ماذا يمكننا أن نبني؟', en: 'What Can We Build?' },
        'svcp.build.sub': { ar: 'فكرة في بالك؟ إليك ما نستطيع تحويله إلى منتج رقمي جاهز', en: 'Have an idea in mind? Here is what we can turn into a ready digital product.' },
        'svcp.build.company': { ar: 'موقع شركة', en: 'Company Website' },
        'svcp.build.store': { ar: 'متجر إلكتروني', en: 'E-commerce Store' },
        'svcp.build.platform': { ar: 'منصة ويب', en: 'Web Platform' },
        'svcp.build.mobile': { ar: 'تطبيق موبايل', en: 'Mobile App' },
        'svcp.build.dashboard': { ar: 'لوحة تحكم', en: 'Dashboard' },
        'svcp.build.system': { ar: 'نظام إدارة مخصص', en: 'Custom Management System' },
